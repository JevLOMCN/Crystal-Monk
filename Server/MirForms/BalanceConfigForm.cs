...
namespace Server
{
    public partial class BalanceConfigForm : Form
    {
        ...
        private void UpdateInterface()
        {
            ...
            {
                BaseStats Stats = Settings.ClassBaseStats[(MirClass)SelectedClassID];
            ...
            MaxHpDrainRatetextBox.Text = Settings.MaxHpDrainRate.ToString();
            MaxReflecttextBox.Text = Settings.MaxReflect.ToString();
            SlowAttackSpeedtextBox.Text = Settings.SlowAttackSpeed.ToString();
            SlowMoveSpeedtextBox.Text = Settings.SlowMoveSpeed.ToString();

            ASpeedBaseMintextBox.Text = Settings.ASpeedBaseMin.ToString();
            ReflectDamagetextBox.Text = Settings.ReflectDamage.ToString();
        ...
        private void HpGaintextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            Settings.ClassBaseStats[(MirClass)SelectedClassID].HpGain = temp;
        }
        ...
        private void HpGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].HpGainRate = temp;
        }
        ...
        private void MpGainBoosttextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MpGainRate = temp;
        }
        ...
        private void BagWeigthGaintextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].BagWeightGain = temp;
        }
        ...
        private void WearWeightGaintextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].WearWeightGain = temp;
        }
        ...
        private void HandWeightGaintextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].HandWeightGain = temp;
        }
        ...
        private void MinAcGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MinAc = temp;
        }
        ...
        private void MaxAcRateGaintextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MaxAc = temp;
        }
        ...
        private void MinMacGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MinMac = temp;
        }
        ...
        private void MaxMacGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MaxMac = temp;
        }
        ...
        private void MinDcGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MinDc = temp;
        }
        ...
        private void MaxDcGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MaxDc = temp;
        }
        ...
        private void MinMcGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MinMc = temp;
        }
        ...
        private void MaxMcGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MaxMc = temp;
        }
        ...
        private void MinScGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MinSc = temp;
        }
        ...
        private void MaxScGainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].MaxSc = temp;
        }
        ...
        private void StartAccuracytextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].StartAccuracy = temp;
        }
        ...
        private void StartAgilitytextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].StartAgility = temp;
        }
        ...
        private void StartCriticalRatetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].StartCriticalRate = temp;
        }
        ...
        private void StartCriticalDamagetextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].StartCriticalDamage = temp;
        }
        ...
        private void CriticalRateGaintextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].CritialRateGain = temp;
        }
        ...
        private void CriticalDamageGaintextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ClassBaseStats[(MirClass)SelectedClassID].CriticalDamageGain = temp;
        }
        ...
        private void MaxReflecttextBox_TextChanged(object sender, EventArgs e)
        {
            if (ActiveControl != sender) return;
            byte temp;
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.MaxReflect = temp;
        }

        private void MaxHpDrainRatetextBox_TextChanged(object sender, EventArgs e)
        {
            if (ActiveControl != sender) return;
            byte temp;
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.MaxHpDrainRate = temp;
        }

        private void MinAttackSpeedtextBox_TextChanged(object sender, EventArgs e)
        {
            if (ActiveControl != sender) return;
            short temp;
        ...
        private void SlowAttackSpeedtextBox_TextChanged(object sender, EventArgs e)
        {
            if (ActiveControl != sender) return;
            short temp;
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.SlowAttackSpeed = temp; ;
        }

        private void SlowMoveSpeedtextBox_TextChanged(object sender, EventArgs e)
        {
            if (ActiveControl != sender) return;
            ushort temp;
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.SlowMoveSpeed = temp;
        }

        private void ASpeedBaseMintextBox_TextChanged(object sender, EventArgs e)
        {
            if (ActiveControl != sender) return;
            ushort temp;
            ...
            ActiveControl.BackColor = SystemColors.Window;
            BaseStatsChanged = true;
            Settings.ASpeedBaseMin = temp;
        }

        private void ASpeedMultipliertextBox_TextChanged(object sender, EventArgs e)
        {
            if (ActiveControl != sender) return;
            ushort temp;
        ...
        private void ReflectDamagetextBox_TextChanged(object sender, EventArgs e)
        {
            if (ActiveControl != sender) return;
            short temp;
