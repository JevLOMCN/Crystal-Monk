...
namespace Server
{
    public partial class SMain : Form
    {
        ...
        private void InterfaceTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                int rpf = 0;
                if (Envir.LastFrames > 0)
                    rpf = Envir.LastRealCount / Envir.LastFrames;
                Text = string.Format("Real: {0} FPS: {1} RPF:{2} SpellCount {3}", Envir.LastRealCount, Envir.LastFrames, rpf,
                ...
                SpawnLeftLabel.Text = string.Format("MonsterLeft: {0}", Envir.TotalMonsterCount - Envir.MonsterCount);
