...
namespace Server.MirDatabase
{
    public class AccountInfo
    {
        ...
        public AccountInfo(BinaryReader reader)
        {
            ...
            DateTimeKind kin = CreationDate.Kind;
            ...
            if (!AdminAccount)
            {
                for (int i = 0; i < Characters.Count; i++)
                {
                  ...
                  //  if ((DateTime.Now - Characters[i].LastDate).TotalDays > 13) continue;
                    SMain.Envir.CheckRankUpdate(RegionID, Characters[i]);
                }
            }
        }
        ...
        public ListViewItem CreateListView()
        {
            ...
            ListItem.SubItems.Add(RegionID.ToString());
        ...
        public void Update()
        {
            ...
            ListItem.SubItems[2].Text = RegionID.ToString();
            ListItem.SubItems[3].Text = Password;
            ListItem.SubItems[4].Text = UserName;
            ListItem.SubItems[5].Text = AdminAccount.ToString();
            ListItem.SubItems[6].Text = Banned.ToString();
            ListItem.SubItems[7].Text = BanReason;
            ListItem.SubItems[8].Text = ExpiryDate.ToString();
        }
