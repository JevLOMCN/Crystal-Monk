...
namespace Server.MirDatabase
{
    public class MapInfo
    {
        ...
        public bool NoTeleport, NoReconnect, NoRandom, NoEscape, NoRecall, NoDrug, NoPosition, NoFight,
            NoThrowItem, NoDropPlayer, NoDropMonster, NoNames, NoMount, NeedBridle, Fight, NeedHole, Fire, Lightning, NoEnter;
        ...
        public void CreateMap(byte regionId)
        {
            if (NPCs.Count == 0)
            {
