...
namespace Server
{
    class Settings
    {
        ...
        [InI("Game")]
        public static string MonkCloneName = "MonkClone";

        [InI("Game")]
        public static string JobKing1 = "JobKing1";

        [InI("Game")]
        public static string JobKing2 = "JobKing2";

        [InI("Game")]
        public static string JobKing3 = "JobKing3";

        [InI("Game")]
        public static string JobKing4 = "JobKing4";

        [InI("Game")]
        public static string CatSlave1 = "JobKing4";

        [InI("Game")]
        public static string CatSlave2 = "JobKing4";

        [InI("Game")]
        public static string TreeQueen1 = "TreeQueen1";
        [InI("Game")]
        public static string TreeQueen2 = "TreeQueen2";

        [InI("Game")]
        public static string KillerPlant1 = "KillerPlant1";
        [InI("Game")]
        public static string KillerPlant2 = "KillerPlant2";
        [InI("Game")]
        public static string KillerPlant3 = "KillerPlant3";
        [InI("Game")]
        public static string KillerPlant4 = "KillerPlant4";

        [InI("Game")]
        public static string HornedCommander1 = "HornedCommander1";

        [InI("Game")]
        public static string SnowWolfKing = "SnowWolfKing";
        [InI("Game")]
        public static string FrozenGolem = "FrozenGolem";

        [InI("Game")]
        public static string TucsonEgg = "TucsonEgg";

        [InI("Game")]
        public static string FloatingRock = "FloatingRock";

        [InI("Game")]
        public static string MoreaWind = "MoreaWind";
        [InI("Game")]
        public static string MoreaStone = "MoreaStone";
        [InI("Game")]
        public static string MoreaKnight = "MoreaKnight";

        [InI("Game")]
        public static string SecretKnight = "SecretKnight";
        [InI("Game")]
        public static string DogYoLin6 = "DogYoLin6";

        [InI("Game")]
        public static string SecretPaper1 = "SecretPaper1";
        ...
        public static uint MaxDropGold = 1000;
        ...
        public static uint FishingExpGain = 1000;
        ...
        //character settings
        public static Dictionary<MirClass, BaseStats> ClassBaseStats = new Dictionary<MirClass, BaseStats>();
        ...
        [InI("Items")]
        public static byte MaxHpDrainRate = 100;

        [InI("Items")]
        public static byte MaxReflect = 100;

        [InI("Items")]
        public static short SlowAttackSpeed = 100;

        [InI("Items")]
        public static ushort SlowMoveSpeed = 100;

        [InI("Items")]
        public static short ReflectDamage = 100;

        [InI("Items")]
        public static ushort ASpeedBaseMin = 370;

        [InI("Game")]
        public static bool AllowStruck = true;

        [InI("Game")]
        public static int StruckDelay = 40;
        ...
        #region command
        [InI("Command")]
        public static string AllowTrade = "ALLOWTRADE";

        [InI("Command")]
        public static string AllowGuild = "ALLOWGUILD";

        [InI("Command")]
        public static string LeaveGuild = "LEAVEGUILD";

        [InI("Command")]
        public static string EnableGroupRecall = "ENABLEGROUPRECALL";

        [InI("Command")]
        public static string GroupCall = "GROUPCALL";

        [InI("Command")]
        public static string RecallMember = "RECALLMEMBER";

        [InI("Command")]
        public static string RecallLover = "RECALLLOVER";
        #endregion

        public static Language lan;

        public static List<HumanMonsterSettings> HumanMon = new List<HumanMonsterSettings>();

        public static List<GameServerInfo> RegionList = new List<GameServerInfo>();


        public static void LoadRegionList()
        {
            RegionList.Clear();
            ...
            for (int i = 0; i < sections.Count; ++i)
            {
                ...
                info.IsOpen = reader.ReadInt32(sections[i], "IsOpen", 0) == 1;
                RegionList.Add(info);

                SMain.Enqueue(string.Format("[{0}]区服[{1}] [{2}], [{3}] IsOpen[{4}]", info.Name, info.RegionID, info.Ip, info.Port, info.IsOpen));
            }
        }
        ...
        public static void Load()
        {
            ...
            InIAttribute.ReadInI<Settings>(Reader);
        ...
        public static void LoadHumanMon()
        {
            if (!Directory.Exists(EnvirPath + HummanMon))
                Directory.CreateDirectory(EnvirPath + HummanMon);
            if (!File.Exists(EnvirPath + HummanMon + @".\Humans.ini"))
            {
                return;
            }

            InIReader reader = new InIReader(EnvirPath + HummanMon + @".\Humans.ini");
            int count = reader.ReadInt32("Count", "HumanMobCount", 0);
            for (int i = 0; i < count; i++)
            {
                HumanMonsterSettings hum = new HumanMonsterSettings
                {
        ...
        public static void Save()
        {
            ...
            InIAttribute.WriteInI<Settings>(Reader);
        }
        ...
        public static void LoadBaseStats()
        {
            ...
            foreach (MirClass clazz in Enum.GetValues(typeof(MirClass)))
            {
                LoadClassBaseStats(reader, clazz);
            }
        }

        private static void LoadClassBaseStats(InIReader reader, MirClass i)
        {
            ClassBaseStats[i] = new BaseStats(i);
            ClassBaseStats[i].HpGain = reader.ReadFloat(i.ToString(), "HpGain", ClassBaseStats[i].HpGain);
            ClassBaseStats[i].HpGainRate = reader.ReadFloat(i.ToString(), "HpGainRate", ClassBaseStats[i].HpGainRate);
            ClassBaseStats[i].MpGainRate = reader.ReadFloat(i.ToString(), "MpGainRate", ClassBaseStats[i].MpGainRate);
            ClassBaseStats[i].BagWeightGain = reader.ReadFloat(i.ToString(), "BagWeightGain", ClassBaseStats[i].BagWeightGain);
            ClassBaseStats[i].WearWeightGain = reader.ReadFloat(i.ToString(), "WearWeightGain", ClassBaseStats[i].WearWeightGain);
            ClassBaseStats[i].HandWeightGain = reader.ReadFloat(i.ToString(), "HandWeightGain", ClassBaseStats[i].HandWeightGain);
            ClassBaseStats[i].MinAc = reader.ReadInt16(i.ToString(), "MinAc", ClassBaseStats[i].MinAc);
            ClassBaseStats[i].MaxAc = reader.ReadInt16(i.ToString(), "MaxAc", ClassBaseStats[i].MaxAc);
            ClassBaseStats[i].MinMac = reader.ReadInt16(i.ToString(), "MinMac", ClassBaseStats[i].MinMac);
            ClassBaseStats[i].MaxMac = reader.ReadInt16(i.ToString(), "MaxMac", ClassBaseStats[i].MaxMac);
            ClassBaseStats[i].MinDc = reader.ReadInt16(i.ToString(), "MinDc", ClassBaseStats[i].MinDc);
            ClassBaseStats[i].MaxDc = reader.ReadInt16(i.ToString(), "MaxDc", ClassBaseStats[i].MaxDc);
            ClassBaseStats[i].MinMc = reader.ReadInt16(i.ToString(), "MinMc", ClassBaseStats[i].MinMc);
            ClassBaseStats[i].MaxMc = reader.ReadInt16(i.ToString(), "MaxMc", ClassBaseStats[i].MaxMc);
            ClassBaseStats[i].MinSc = reader.ReadInt16(i.ToString(), "MinSc", ClassBaseStats[i].MinSc);
            ClassBaseStats[i].MaxSc = reader.ReadInt16(i.ToString(), "MaxSc", ClassBaseStats[i].MaxSc);
            ClassBaseStats[i].StartAgility = reader.ReadInt16(i.ToString(), "StartAgility", ClassBaseStats[i].StartAgility);
            ClassBaseStats[i].StartAccuracy = reader.ReadInt16(i.ToString(), "StartAccuracy", ClassBaseStats[i].StartAccuracy);
            ClassBaseStats[i].StartCriticalRate = reader.ReadInt16(i.ToString(), "StartCriticalRate", ClassBaseStats[i].StartCriticalRate);
            ClassBaseStats[i].StartCriticalDamage = reader.ReadInt16(i.ToString(), "StartCriticalDamage", ClassBaseStats[i].StartCriticalDamage);
            ClassBaseStats[i].CritialRateGain = reader.ReadInt16(i.ToString(), "CritialRateGain", ClassBaseStats[i].CritialRateGain);
            ClassBaseStats[i].CriticalDamageGain = reader.ReadInt16(i.ToString(), "CriticalDamageGain", ClassBaseStats[i].CriticalDamageGain);
        }
        ...
        public static void SaveBaseStats()
        {
            ...
            foreach (MirClass i in Enum.GetValues(typeof(MirClass)))
            {
                reader.Write(i.ToString(), "HpGain", ClassBaseStats[i].HpGain);
                reader.Write(i.ToString(), "HpGainRate", ClassBaseStats[i].HpGainRate);
                reader.Write(i.ToString(), "MpGainRate", ClassBaseStats[i].MpGainRate);
                reader.Write(i.ToString(), "BagWeightGain", ClassBaseStats[i].BagWeightGain);
                reader.Write(i.ToString(), "WearWeightGain", ClassBaseStats[i].WearWeightGain);
                reader.Write(i.ToString(), "HandWeightGain", ClassBaseStats[i].HandWeightGain);
                reader.Write(i.ToString(), "MinAc", ClassBaseStats[i].MinAc);
                reader.Write(i.ToString(), "MaxAc", ClassBaseStats[i].MaxAc);
                reader.Write(i.ToString(), "MinMac", ClassBaseStats[i].MinMac);
                reader.Write(i.ToString(), "MaxMac", ClassBaseStats[i].MaxMac);
                reader.Write(i.ToString(), "MinDc", ClassBaseStats[i].MinDc);
                reader.Write(i.ToString(), "MaxDc", ClassBaseStats[i].MaxDc);
                reader.Write(i.ToString(), "MinMc", ClassBaseStats[i].MinMc);
                reader.Write(i.ToString(), "MaxMc", ClassBaseStats[i].MaxMc);
                reader.Write(i.ToString(), "MinSc", ClassBaseStats[i].MinSc);
                reader.Write(i.ToString(), "MaxSc", ClassBaseStats[i].MaxSc);
                reader.Write(i.ToString(), "StartAgility", ClassBaseStats[i].StartAgility);
                reader.Write(i.ToString(), "StartAccuracy", ClassBaseStats[i].StartAccuracy);
                reader.Write(i.ToString(), "StartCriticalRate", ClassBaseStats[i].StartCriticalRate);
                reader.Write(i.ToString(), "StartCriticalDamage", ClassBaseStats[i].StartCriticalDamage);
                reader.Write(i.ToString(), "CritialRateGain", ClassBaseStats[i].CritialRateGain);
                reader.Write(i.ToString(), "CriticalDamageGain", ClassBaseStats[i].CriticalDamageGain);
            }
        }
        ...
        public static void LinkGuildCreationItems(Dictionary<int, ItemInfo> ItemList)
        {
            for (int i = 0; i < Guild_CreationCostList.Count; i++)
            {
                if (Guild_CreationCostList[i].ItemName != "")
                    ...
                    {
                        if (string.Compare(item.Name.Replace(" ", ""), Guild_CreationCostList[i].ItemName, StringComparison.OrdinalIgnoreCase) != 0) continue;
                        Guild_CreationCostList[i].Item = item;
                        break;
                    }
        ...
        public static void LoadFishing()
        {
            ...
            FishingExpGain = reader.ReadUInt32("Rates", "FishingExpGain", FishingExpGain);
        }
        ...
        internal static bool RegionIsOpen(byte regionId)
        {
            for (int i=0; i<RegionList.Count; ++i)
            {
                if (RegionList[i].RegionID == regionId)
                    return RegionList[i].IsOpen;
            }
