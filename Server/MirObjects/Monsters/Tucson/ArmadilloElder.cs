...
{
    public class ArmadilloElder : MonsterObject
    {
        ...
        protected override void RangeAttack()
        {
            ...
            DelayedAction action = new DelayedAction(DelayedType.RangeDamage + 800, Envir.Time, Target, damage, DefenceType.MACAgility, 0);
            ActionList.Add(action);

            action = new DelayedAction(DelayedType.RangeDamage + 1300, Envir.Time, Target, damage, DefenceType.MACAgility, 0);
            ActionList.Add(action);
        }
