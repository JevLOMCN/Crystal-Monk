...
{
    public class SecretWarrior2 : MonsterObject
    {
        protected internal SecretWarrior2(MonsterInfo info)
            : base(info)
        {
        }
        ...
        protected override void CompleteRangeAttack(IList<object> data)
        {
            ...
            switch (type)
            {
                case 0:
                    ...
                    Broadcast(new S.ObjectEffect { ObjectID = target.ObjectID, Effect = SpellEffect.SecretWarrior2 });
