...
namespace Server.MirObjects.Monsters
{
    public class HumanWizard : MonsterObject
    {
        ...
        public long NextMagicShieldTime;
        ...
        protected override void ProcessAI()
        {
            ...
            if (Master != null && Master is PlayerObject && Envir.Time > DecreaseMPTime)
            {
                ...
                if (((PlayerObject)Master).MP <= 1f * ((PlayerObject)Master).MaxMP / 3 ) Die();
            }
        }
        ...
        {
            //  Favour MagicShield
            if (!MagicShield && Envir.Time > NextMagicShieldTime)
            {
        ...
        private void PerformMagicShield()
        {
