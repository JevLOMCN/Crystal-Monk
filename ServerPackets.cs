...
namespace ServerPackets
{
    public sealed class ServerList : Packet
    {
        ...
        protected override void ReadPacket(BinaryReader reader)
        {
            ...
            Announcement = reader.ReadString();
        }
    ...
    public sealed class OnlinePlayers : Packet
    {
        public override short Index { get { return (short)ServerPacketIds.OnlinePlayers; } }

        public List<SelectInfo> list = new List<SelectInfo>();
        ...
        protected override void ReadPacket(BinaryReader reader)
        {
            ...
            for (int i = 0; i < count; i++)
                list.Add(new SelectInfo(reader));
        }
    ...
    public sealed class RearrangeInventory : Packet
    {
        public override short Index { get { return (short)ServerPacketIds.RearrangeInventory;  } }
    ...
    public sealed class DownloadFile : Packet
    {
        ...
        public override short Index
        {
            get
            {
                return (short)ServerPacketIds.DownloadFile;
            }
        }
    ...
    public sealed class ChangeNameRequest : Packet
    {
        public override short Index
        {
            get
            {
                return (short)ServerPacketIds.ChangeNameRequest;
            }
        }
        protected override void ReadPacket(BinaryReader reader)
        { }
