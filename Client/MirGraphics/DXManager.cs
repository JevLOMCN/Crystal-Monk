...
namespace Client.MirGraphics
{
    ...
    class DXManager
    {
        ...
        public static string GrayShader = @"ps_1_2
        ...
        private static unsafe void LoadPixelsShaders()
        {
            ...
            using (var gs = ShaderLoader.FromString(GrayShader, null, ShaderFlags.None))
        ...
        private static unsafe void LoadTextures()
        {
            ...
            {
                RadarTexture = new Texture(Device, 3, 3, 1, Usage.None, Format.A8R8G8B8, Pool.Managed);

                using (GraphicsStream stream = RadarTexture.LockRectangle(0, LockFlags.Discard))
                using (Bitmap image = new Bitmap(3, 3, 12, PixelFormat.Format32bppArgb, (IntPtr)stream.InternalDataPointer))
