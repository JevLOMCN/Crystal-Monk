...
namespace Client.MirSounds
{
    static class SoundManager
    {
        ...
        public static void LoadSoundList()
        {
            ...
            {
                CMain.SaveError("begin..........................");
                foreach (string f in IndexList.Values)
                {
                    string filePath = Path.Combine(Settings.SoundPath, f);
                    if (!File.Exists(filePath))
                        CMain.SaveError(string.Format("File not found {0}", filePath));
                }
                CMain.SaveError("end..........................");
            }
        }
