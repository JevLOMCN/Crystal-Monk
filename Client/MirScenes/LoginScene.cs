...
namespace Client.MirScenes
{
    public sealed class LoginScene : MirScene
    {
        ...
        {
            _connectBox.Label.Text = CMain.Tr("Sending Client Version.");
        ...
        private void NewAccount(S.NewAccount p)
        {
            ...
            {
                case 0:
                    MirMessageBox.Show(CMain.Tr("Account creation is currently disabled."));
                    _account.Dispose();
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    MirMessageBox.Show(CMain.Tr("Your E-Mail Address is not acceptable."));
                    _account.EMailTextBox.SetFocus();
                    break;
                case 4:
                    MirMessageBox.Show(CMain.Tr("Your User Name is not acceptable."));
                    _account.UserNameTextBox.SetFocus();
                    break;
                case 5:
                    MirMessageBox.Show(CMain.Tr("Your Secret Question is not acceptable."));
                    _account.QuestionTextBox.SetFocus();
                    break;
                case 6:
                    MirMessageBox.Show(CMain.Tr("Your Secret Answer is not acceptable."));
                    _account.AnswerTextBox.SetFocus();
                    break;
                case 7:
                    MirMessageBox.Show(CMain.Tr("An Account with this ID already exists."));
                    _account.AccountIDTextBox.Text = string.Empty;
                    _account.AccountIDTextBox.SetFocus();
                    break;
                case 8:
                    MirMessageBox.Show(CMain.Tr("Your account was created successfully."));
                    _account.Dispose();
                    break;
            }
        }
        private void ChangePassword(S.ChangePassword p)
        {
            ...
            {
                case 0:
                    MirMessageBox.Show(CMain.Tr("Password Changing is currently disabled."));
                    _password.Dispose();
                    break;
                case 1:
                    MirMessageBox.Show(CMain.Tr("Your AccountID is not acceptable."));
                    ...
                    break;
                case 2:
                    MirMessageBox.Show(CMain.Tr("The current Password is not acceptable."));
                    _password.CurrentPasswordTextBox.SetFocus();
                    break;
                case 3:
                    MirMessageBox.Show(CMain.Tr("Your new Password is not acceptable."));
                ...
                case 5:
                    ...
                    break;
                case 6:
                    MirMessageBox.Show(CMain.Tr("Your password was changed successfully."));
                    _password.Dispose();
                    break;
            }
        }
        ...
        public sealed class LoginDialog : MirImageControl
        {
            ...
            private void Login()
            {
                ...
                Network.Enqueue(new C.Login {AccountID = AccountIDTextBox.Text, Password = PasswordTextBox.Text, RegionId = Network.ServerInfo.RegionID});
            }
        ...
        public sealed class NewAccountDialog : MirImageControl
        {
            ...
            private void CreateAccount()
            {
                ...
                Network.Enqueue(new C.NewAccount
                {
                    ...
                    RegionID = Network.ServerInfo.RegionID
                });
            }
