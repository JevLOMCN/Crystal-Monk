...
namespace Client.MirScenes.Dialogs
{
    public sealed class QuestListDialog : MirImageControl
    {
        ...
        public QuestListDialog()
        {
            ...
            _finishButton.Click += (o, e) =>
            {
                ...
                {
                    MirMessageBox messageBox = new MirMessageBox(CMain.Tr("You must select a reward item."));
                    messageBox.Show();
                    return;
                }
    ...
    public sealed class QuestDetailDialog : MirImageControl
    {
        ...
        public QuestDetailDialog()
        {
            ...
            {
                MirMessageBox messageBox = new MirMessageBox(CMain.Tr("Are you sure you want to cancel this quest?"), MirMessageBoxButtons.YesNo);
    ...
    public sealed class QuestSingleQuestItem : MirControl
    {
        ...
        public QuestSingleQuestItem(ClientQuestProgress quest)
        {
            ...
            string state = quest.Completed ? CMain.Tr("(Complete)") : CMain.Tr("(In Progress)");
