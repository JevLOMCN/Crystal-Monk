...
namespace Client.MirScenes.Dialogs
{
    ...
    {
        public static int RANK_NUM = 7;
        public MirButton AllButton, WarButton, WizButton, TaoButton, SinButton, ArchButton, MonkButton, Tab7, NextButton, PrevButton;
        ...
        public List<Rank_Character_Info>[] RankList = new List<Rank_Character_Info>[7];
        public int[] Rank = new int[RANK_NUM];

        public long[] LastRequest = new long[RANK_NUM];
        ...
        public RankingDialog()
        {
            ...
            MonkButton = new MirButton
            {
                ...
                HoverIndex = 808,
                Library = Libraries.Title,
                Hint = CMain.Tr("TOP 20 Monks"),
                Location = new Point(140, 38),
                Parent = this,
                Sound = SoundList.ButtonA,
            };
            MonkButton.Click += (o, e) => RequestRanks(6);
        ...
        public void UpdateRanks()
        {
            ...
            if (Rank[RankType] == 0)
                MyRank.Text = CMain.Tr("Not Listed");
            else
                MyRank.Text = string.Format(CMain.Tr("Ranked: {0}"), Rank[RankType]); ;
        ...
        public sealed class RankingRow : MirControl
        {
            ...
            public void Update(Rank_Character_Info listing, int RankIndex)
            {
                ...
                ClassLabel.Text = CMain.Tr(Listing.Class.ToString());
