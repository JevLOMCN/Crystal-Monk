    ...
    public class MailListDialog : MirImageControl
    {
        ...
        public MailListDialog()
        {
            ...
            SendButton.Click += (o, e) =>
                {
                    MirInputBox inputBox = new MirInputBox(CMain.Tr("Please enter the name of the person you would like to mail."));
            ...
            DeleteButton.Click += (o, e) =>
            {
                ...
                {
                    MirMessageBox messageBox = new MirMessageBox(CMain.Tr("This parcel contains items or gold. Are you sure you want to delete it?"), MirMessageBoxButtons.YesNo);

                    messageBox.YesButton.Click += (o1, e1) =>
                    {
                        Network.Enqueue(new C.DeleteMail { MailID = SelectedMail.MailID });
                        SelectedMail = GetNextMail();
                    };
        ...
        private ClientMail GetNextMail()
        {
            bool find = false;
            for (int i = 0; i < Rows.Length; i++)
            {
                ...
                if (Rows[i].Mail.MailID == SelectedMail.MailID)
                {
                    find = true;
                    continue;
                }
    ...
    public class MailComposeParcelDialog : MirImageControl
    {
        ...
        public MailComposeParcelDialog()
        {
            ...
            GoldSendLabel.Click += (o, e) =>
            {
                ...
                {
                    MirAmountBox amountBox = new MirAmountBox(CMain.Tr("Send Amount:"), 116, GameScene.Gold);
