...
namespace Client.MirObjects
{
    ...
    {
        public static MirAction DebugAction;
        ...
        public Dictionary<int, int> FrameIntervals = new Dictionary<int, int>();

        public static MonsterObject GetMonster(uint ObjectID, Monster BaseImage)
        {
            switch(BaseImage)
            {
                case Monster.DarkOmaKing: return new DarkOmaKing(ObjectID);

                // 猫洞
                case Monster.FightingCat: return new CatFighting(ObjectID);
                case Monster.FireCat: return new CatFire(ObjectID);
                case Monster.CatWidow: return new CatWidow(ObjectID);
                case Monster.StainHammerCat: return new StainHammerCat(ObjectID);
                case Monster.BlackHammerCat: return new BlackHammerCat(ObjectID);
                case Monster.StrayCat: return new StrayCat(ObjectID);
                case Monster.CatShaman: return new CatShaman(ObjectID);
                case Monster.Jar1: return new Jar1(ObjectID);
                case Monster.Jar2: return new Jar2(ObjectID);
                case Monster.SeedingsGeneral: return new SeedingsGeneral(ObjectID);
                case Monster.RestlessJar: return new RestlessJar(ObjectID);
                case Monster.GeneralJinmYo: return new CatBigBoss(ObjectID);

                case Monster.TucsonMage: return new TucsonMage(ObjectID);
                case Monster.TucsonWarrior: return new TucsonWarrior(ObjectID);
                case Monster.Armadillo: return new Armadillo(ObjectID);
                case Monster.ArmadilloElder: return new ArmadilloElder(ObjectID);
                case Monster.SandSnail: return new SandSnail(ObjectID);
                case Monster.CannibalTentacles: return new CannibalTentacles(ObjectID);
                case Monster.TucsonGeneral: return new TucsonGeneral(ObjectID);

                // 如何
                case Monster.GasToad: return new GasToad(ObjectID);
                case Monster.Mantis: return new Mantis(ObjectID);
                case Monster.SwampWarrior: return new SwampWarrior(ObjectID);
                case Monster.AssassinBird: return new AssassinBird(ObjectID);
                case Monster.RhinoWarrior: return new RhinoWarrior(ObjectID);
                case Monster.RhinoPriest: return new RhinoPriest(ObjectID);
                case Monster.SwampSlime: return new SwampSlime(ObjectID);
                case Monster.RockGuard: return new RockGuard(ObjectID);
                case Monster.MudWarrior: return new MudWarrior(ObjectID);
                case Monster.SmallPot: return new SmallPot(ObjectID);
                case Monster.TreeQueen: return new TreeQueen(ObjectID);
                case Monster.ShellFighter: return new ShellFighter(ObjectID);

                // 片木岛
                case Monster.Mandrill: return new Mandrill(ObjectID);
                case Monster.PlagueCrab: return new PlagueCrab(ObjectID);
                case Monster.CreeperPlant: return new CreeperPlant(ObjectID);
                case Monster.FloatingWraith: return new FloatingWraith(ObjectID);
                case Monster.ArmedPlant: return new ArmedPlant(ObjectID);
                case Monster.AvengerPlant: return new AvengerPlant(ObjectID);
                case Monster.Nadz: return new Nadz(ObjectID);
                case Monster.AvengingSpirit: return new AvengingSpirit(ObjectID);
                case Monster.AvengingWarrior: return new AvengingWarrior(ObjectID);
                case Monster.AxePlant: return new AxePlant(ObjectID);
                case Monster.WoodBox: return new WoodBox(ObjectID);
                case Monster.ClawBeast: return new ClawBeast(ObjectID);
                case Monster.KillerPlant: return new KillerPlant(ObjectID);

                // 沙遗址
                case Monster.SackWarrior: return new SackWarrior(ObjectID);
                case Monster.WereTiger: return new WereTiger(ObjectID);
                case Monster.KingHydrax: return new KingHydrax(ObjectID);
                case Monster.Hydrax: return new Hydrax(ObjectID);
                case Monster.HornedMage: return new HornedMage(ObjectID);
                case Monster.HornedArcher: return new HornedArcher(ObjectID);
                case Monster.ColdArcher: return new ColdArcher(ObjectID);
                case Monster.HornedWarrior: return new HornedWarrior(ObjectID);
                case Monster.FloatingRock: return new FloatingRock(ObjectID);
                case Monster.ScalyBeast: return new ScalyBeast(ObjectID);
                case Monster.HornedSorceror: return new HornedSorceror(ObjectID);
                case Monster.BoulderSpirit: return new BoulderSpirit(ObjectID);
                case Monster.HornedCommander: return new HornedCommander(ObjectID);
                case Monster.MoreaWind: return new MoreaWind(ObjectID);
                // case Monster.MoonStone: return new MoonStone(ObjectID);


                // 玄月林
                case Monster.SunStone: return new SunStone(ObjectID);
                //   case Monster.LightningStone: return new LightningStone(ObjectID);
                case Monster.Turtlegrass: return new TurtleGrass(ObjectID);
                case Monster.Mantree: return new ManTree(ObjectID);
                case Monster.Bear: return new Bear(ObjectID);
                // case Monster.Leopard: return new Leopard(ObjectID);
                case Monster.ChieftainArcher: return new ChieftainArcher(ObjectID);
                case Monster.ChieftainSword: return new JobKing(ObjectID);
                    /*
                case Monster.StoningSpider: return new StoningSpider(ObjectID);
                case Monster.VampireSpider: return new VampireSpider(ObjectID);
                case Monster.SpittingToad: return new SpittingToad(ObjectID);
                case Monster.SnakeTotem: return new SnakeTotem(ObjectID);
                case Monster.CharmedSnake: return new CharmedSnake(ObjectID);
                */

                // 雪原
                case Monster.FrozenSoldier: return new FrozenSoldier(ObjectID);
                case Monster.FrozenFighter: return new FrozenFighter(ObjectID);
                case Monster.FrozenArcher: return new FrozenArcher(ObjectID);
                case Monster.FrozenKnight: return new FrozenKnight(ObjectID);
                case Monster.FrozenGolem: return new FrozenGolem(ObjectID);
                case Monster.IcePhantom: return new IcePhantom(ObjectID);
                case Monster.SnowWolf: return new SnowWolf(ObjectID);
                case Monster.SnowWolfKing: return new SnowWolfKing(ObjectID);

                // 神鬼
                case Monster.WaterDragon: return new WaterDragon(ObjectID);
                case Monster.BlackTortoise: return new BlackTortoise(ObjectID);
                case Monster.Manticore: return new Manticore(ObjectID);
                case Monster.DragonWarrior: return new DragonWarrior(ObjectID);
                case Monster.DragonArcher: return new DragonArcher(ObjectID);
                case Monster.Kirin: return new Kirin(ObjectID);

                //       case Monster.Guard3: return new Guard3(ObjectID);
                //       case Monster.ArcherGuard3: return new ArcherGuard3(ObjectID);
                //       case Monster.Bunny2: return new Bunny2(ObjectID);

                // 冰川
                case Monster.FrozenMiner: return new FrozenMiner(ObjectID);
                case Monster.FrozenAxeman: return new FrozenAxeman(ObjectID);
                case Monster.FrozenMagician: return new FrozenMagician(ObjectID);
                case Monster.SnowYeti: return new SnowYeti(ObjectID);
                case Monster.IceCrystalSoldier: return new IceCrystalSoldier(ObjectID);
                case Monster.DarkWraith: return new DarkWraith(ObjectID);
                case Monster.DarkSpirit: return new DarkSpirit(ObjectID);
                case Monster.CrystalBeast: return new CrystalBeast(ObjectID);

                // 冰原
                case Monster.SnowFlower: return new SnowFlower(ObjectID);
                case Monster.SnowMouse: return new SnowMouse(ObjectID);
                case Monster.SnowSnail: return new SnowSnail(ObjectID);
                case Monster.SnowWarrior: return new SnowWarrior(ObjectID);
                case Monster.SnowArchor: return new SnowArchor(ObjectID);
                case Monster.SnowAssassin: return new SnowAssassin(ObjectID);
                case Monster.SnowFlowerQueen: return new SnowFlowerQueen(ObjectID);
                // 地宫
                case Monster.SecretWarrior2: return new SecretWarrior2(ObjectID);
                case Monster.SecretWarrior3: return new SecretWarrior3(ObjectID);
                case Monster.SecretWarrior4: return new SecretWarrior4(ObjectID);
                case Monster.SecretKnight: return new SecretKnight(ObjectID);
                case Monster.SecretPaper1: return new SecretPaper1(ObjectID);
                case Monster.SecretPaper2: return new SecretPaper2(ObjectID);
                case Monster.SecretPaper3: return new SecretPaper3(ObjectID);
                case Monster.SecretPaper4: return new SecretPaper4(ObjectID);
                case Monster.SecretJudge: return new SecretJudge(ObjectID);
                case Monster.SecretWizard: return new SecretWizard(ObjectID);
                case Monster.SecretWarrior8: return new SecretWarrior8(ObjectID);
                case Monster.SecretQueen: return new SecretQueen(ObjectID);

                /*
                      // 昆仑
                      case Monster.KunLun0: return new KunLun0(ObjectID);
                      case Monster.KunLun1: return new KunLun1(ObjectID);
                      case Monster.KunLun2: return new KunLun2(ObjectID);
                      case Monster.KunLun3: return new KunLun3(ObjectID);
                      case Monster.KunLun4: return new KunLun4(ObjectID);
                      case Monster.KunLun5: return new KunLun5(ObjectID);
                      case Monster.KunLun6: return new KunLun6(ObjectID);
                      case Monster.KunLun7: return new KunLun7(ObjectID);
                      case Monster.KunLun8: return new KunLun8(ObjectID);
                      case Monster.KunLun9: return new KunLun9(ObjectID);
                      case Monster.KunLun10: return new KunLun10(ObjectID);
                      case Monster.KunLun11: return new KunLun11(ObjectID);
                      case Monster.KunLun12: return new KunLun12(ObjectID);
                      case Monster.KunLun13: return new KunLun13(ObjectID);
                      case Monster.KunLun14: return new KunLun14(ObjectID);

                      case Monster.DogYoLin0:return new DogYoLin0(ObjectID);
                      case Monster.DogYoLin1:return new DogYoLin1(ObjectID);
                      case Monster.DogYoLin2:return new DogYoLin2(ObjectID);
                      case Monster.DogYoLin3:return new DogYoLin3(ObjectID);
                      case Monster.DogYoLin4:return new DogYoLin4(ObjectID);
                      case Monster.DogYoLin5:return new DogYoLin5(ObjectID);
                      case Monster.DogYoLin6:return new DogYoLin6(ObjectID);
                      case Monster.DogYoLin7:return new DogYoLin7(ObjectID);
                      case Monster.DogYoLin8:return new DogYoLin8(ObjectID);
                      */


                default:
                    return new MonsterObject(ObjectID);
            }
        }
        ...
        protected virtual void CalcFrames(ref S.ObjectMonster info)
        {
            switch (BaseImage)
            {
                case Monster.Guard:
                ...
                case Monster.SecretPaper4:
                    ...
                    break;
                case Monster.SecretJudge:
                    Frames = FrameSet.Monsters[223];
                    break;
                case Monster.SecretWizard:
                    Frames = FrameSet.Monsters[224];
                    break;
                case Monster.SecretWarrior8:
                    Frames = FrameSet.Monsters[225];
                    break;
                case Monster.SecretQueen:
                    Frames = FrameSet.Monsters[226];
                    break;
                case Monster.MoreaWind:
                    Frames = FrameSet.Monsters[227];
                    break;

                case Monster.KunLun0:
                case Monster.KunLun1:
                case Monster.KunLun2:
                case Monster.KunLun3:
                case Monster.KunLun4:
                case Monster.KunLun5:
                case Monster.KunLun6:
                case Monster.KunLun7:
                case Monster.KunLun8:
                case Monster.KunLun9:
                case Monster.KunLun10:
                case Monster.KunLun11:
                case Monster.KunLun12:
                case Monster.KunLun13:
                    Frames = FrameSet.Monsters[BaseImage - Monster.KunLun0 + 229];
                    break;
                case Monster.KunLun14:
                    Frames = FrameSet.Monsters[243 + Stage];
                    break;
                case Monster.DogYoLin0:
                case Monster.DogYoLin1:
                case Monster.DogYoLin2:
                case Monster.DogYoLin3:
                case Monster.DogYoLin4:
                case Monster.DogYoLin5:
                case Monster.DogYoLin6:
                case Monster.DogYoLin7:
                case Monster.DogYoLin8:
                    Frames = FrameSet.Monsters[BaseImage - Monster.DogYoLin0 + 245];
                    break;

                case Monster.DogYoLinDoor:
        ...
        protected virtual void SetAttack1Action()
        {
            switch (BaseImage)
            {
                case Monster.FlamingWooma:
                ...
                case Monster.FlamingMutant:///////////////////////////stupple 
                    Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FlamingMutant], 304, 16, Frame.Count * Frame.Interval, this));
                    break;
                ...
                case Monster.AncientBringer:
                    ...
                    Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.AncientBringer], 560, 8, 8 * Frame.Interval, this, CMain.Time + 1000)
                    {
        ...
        protected virtual void SetAttack2Action()
        {
            switch (BaseImage)
            {
                case Monster.CrystalSpider:
                ...
                case Monster.ManectricKing:
                    ...
                    break;
                case Monster.DeathCrawler:
                    Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.DeathCrawler], 272 + (int)Direction * 4, 4, Frame.Count * Frame.Interval, this));
                    break;
                case Monster.Demonwolf:
        ...
        protected virtual void SetAttack3Action()
        {
            switch (BaseImage)
            {
                case Monster.Yimoogi:
                ...
                case Monster.OmaWitchDoctor:
                    {
                        ...
                        Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OmaWitchDoctor], 800 + (int)Direction * 7, 7, Frame.Count * Frame.Interval, this));
                        Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OmaWitchDoctor], 856, 11, 11 * Frame.Interval, this, CMain.Time + 1000)
                        {
                            // 297 356   48 32
        ...
        protected virtual void SetAttackRange1Action()
        {
            switch (BaseImage)
            {
                case Monster.KingScorpion:
                ...
                case Monster.BurningZombie:
                    ...
                    break;
                case Monster.AncientBringer:
                    Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.AncientBringer], 648 + (int)Direction * 5, 5, Frame.Count * Frame.Interval, this));
                    break;
            }
        }

        protected virtual void SetAttackRange2Action()
        {
            switch (BaseImage)
            {
                case Monster.TurtleKing:
        ...
        public virtual void SetAttackRange3Action()
        {
            switch (BaseImage)
            {
                case Monster.TurtleKing:
        ...
        protected virtual void SetDieAction()
        {
            switch (BaseImage)
            {
                case Monster.ManectricKing:
        ...
        protected virtual void SetAppearAction()
        {
            switch (BaseImage)
            {
                case Monster.HellKnight1:
        ...
        public virtual bool SetAction()
        {
            ...
            else
            {
                ...
                if (DebugAction != MirAction.Standing)
                    CurrentAction = DebugAction;

                CalcActorFrame(action);
            }
        ...
        public virtual bool CalcActorFrame(QueuedAction action)
        {
            switch (CurrentAction)
            {
                case MirAction.Pushed:
            ...
            switch (CurrentAction)
            {
                ...
                case MirAction.AttackRange2:
                    PlayRange2Sound();
                    TargetID = (uint)action.Params[0];
                    SetAttackRange2Action();
                    break;

                case MirAction.AttackRange3:
                    PlayRange3Sound();
                    TargetID = (uint)action.Params[0];
                    SetAttackRange3Action();
                    break;
        ...
        protected virtual void ProcessAttackRange1Frame()
        {
            if (CMain.Time >= NextMotion)
            {
                GameScene.Scene.MapControl.TextureValid = false;
                ...
                else
                {
                        ...
                        case 4:
                            {
                                switch (BaseImage)
                                {
                                    ...
                                    case Monster.AncientBringer:
                                        if (MapControl.GetObject(TargetID) != null)
                                        {
                                            missile = CreateProjectile(688, Libraries.Monsters[(ushort)Monster.AncientBringer], true, 4, 30, 0, false);
                                    ...
                                    case Monster.FlamingMutant:
                                        {
                                            ...
                                            if (ob != null)
                                            {
                                                ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.FlamingMutant], 320, 9, 1200, ob));
                                            }
                                        }
                                        break;
                                }
                    ...
                    if (FrameIntervals.ContainsKey(FrameIndex))
                        NextMotion += FrameIntervals[FrameIndex];
                    else
                        NextMotion += FrameInterval;
                }
            }
        ...
        private void ProcessAttackFrame()
        {
            if (CMain.Time >= NextMotion)
            {
                GameScene.Scene.MapControl.TextureValid = false;
        ...
        private void ProcessAttack2Frame()
        {
            if (CMain.Time >= NextMotion)
            {
                GameScene.Scene.MapControl.TextureValid = false;
        ...
        protected virtual void ProcessAttackRange2Frame()
        {
            if (CMain.Time >= NextMotion)
            {
                GameScene.Scene.MapControl.TextureValid = false;
                        ...
                        case 4:
                            {
                                ...
                                switch (BaseImage)
                                {
                                    ...
                                    case Monster.OmaWitchDoctor:
                                        ...
                                        if (ob != null)
                                        {
                                            ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.OmaWitchDoctor], 867, 10, 1200, ob));
                                        }
                                        break;
                                }
                                break;
        ...
        protected virtual void ProcessAttack3Frame()
        {
            if (CMain.Time >= NextMotion)
            {
                GameScene.Scene.MapControl.TextureValid = false;
        ...
        protected virtual void ProcessAttack4Frame()
        {
            if (CMain.Time >= NextMotion)
            {
                GameScene.Scene.MapControl.TextureValid = false;
        ...
        protected virtual void ProcessAttackRange3Frame()
        {
            if (CMain.Time >= NextMotion)
            {
                GameScene.Scene.MapControl.TextureValid = false;
        ...
        protected virtual void ProcessAttackRange4Frame()
        {
            if (CMain.Time >= NextMotion)
            {
                GameScene.Scene.MapControl.TextureValid = false;
        ...
        protected virtual void ProcessDieFrame()
        {
            if (CMain.Time >= NextMotion)
            {
                GameScene.Scene.MapControl.TextureValid = false;
        ...
        private void ProcessFrames()
        {
            ...
            switch (CurrentAction)
            {
                ...
                case MirAction.Attack4:
                    ...
                    break;
                case MirAction.AttackRange1:
                    ProcessAttackRange1Frame();
                    break;
                case MirAction.AttackRange2:
                    ProcessAttackRange2Frame();
                    break;
                case MirAction.AttackRange3:
                    ProcessAttackRange3Frame();
                    break;
                case MirAction.AttackRange4:
                    ProcessAttackRange4Frame();
                    break;
                case MirAction.Struck:
                    if (CMain.Time >= NextMotion)
                    {
        ...
        protected virtual bool AfterFrameFinish()
        {
            return false;
        }
        ...
        public override void Draw()
        {
            ...
            if (!DXManager.Blending && Frame.Blend)
                BodyLibrary.DrawBlendEx(DrawFrame, DrawLocation, DrawColour, true);
            else
        ...
        protected virtual void DrawBlendEffects()
        {
            switch (BaseImage)
            {
                case Monster.Scarecrow:
        ...
        protected virtual void SetAttack4Action()
        {
        }

        protected virtual void AfterSetStandingAction()
        {
        }
