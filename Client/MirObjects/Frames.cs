...
namespace Client.MirObjects
{
    public class FrameSet
    {
        ...
        static FrameSet()
        {
            ...
            Players.Frames.Add(MirAction.Attack1, new Frame(136, 6, 0, 100, 168, 6, 0, 100));//普通攻击
            Players.Frames.Add(MirAction.Attack2, new Frame(184, 6, 0, 100, 216, 6, 0, 100));//站立双手攻击
            Players.Frames.Add(MirAction.Attack3, new Frame(232, 8, 0, 100, 264, 8, 0, 100));//跳起双手攻击
            Players.Frames.Add(MirAction.Attack4, new Frame(416, 6, 0, 100, 448, 6, 0, 100,MirAction.Attack4));//刺客右手攻击
            ...
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 4, 200, 0, 8, 0, 200));
            ...
            frame.Frames.Add(MirAction.Stance2, new Frame(460, 1, 7, 800, 192, 1, 5, 800));
            ...
            frame.Frames.Add(MirAction.Attack4, new Frame(328, 6, 2, 100, 374, 6, 0, 100));
            ...
            frame.Frames.Add(MirAction.Dead, new Frame(539, 1, 7, 800, 439, 1, 7, 800));
            frame.Frames.Add(MirAction.Revive, new Frame(536, 4, 4, 100, 536, 4, 4, 100) { Reverse = true });
            ...
            //Archer
            frame.Frames.Add(MirAction.WalkingBow, new Frame(0, 6, 0, 100, 0, 6, 0, 100));
            frame.Frames.Add(MirAction.RunningBow, new Frame(48, 6, 0, 100, 48, 6, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(96, 8, 0, 100, 96, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(160, 8, 0, 100, 160, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(224, 8, 0, 100, 224, 8, 0, 100));
            frame.Frames.Add(MirAction.Jump, new Frame(288, 8, 0, 100, 288, 8, 0, 100));
            //Mounts
            frame.Frames.Add(MirAction.MountStanding, new Frame(792, 4, 4, 500, 792, 4, 4, 500));
            frame.Frames.Add(MirAction.MountWalking, new Frame(856, 8, 0, 100, 856, 8, 0, 100));
            frame.Frames.Add(MirAction.MountRunning, new Frame(920, 6, 2, 100, 920, 6, 2, 100));
            frame.Frames.Add(MirAction.MountStruck, new Frame(984, 3, 5, 100, 984, 3, 5, 100));
            frame.Frames.Add(MirAction.MountAttack, new Frame(1048, 6, 2, 100, 1048, 6, 2, 100));
            //Fishing
            frame.Frames.Add(MirAction.FishingCast, new Frame(600, 8, 0, 100, 600, 8, 0, 100));
            frame.Frames.Add(MirAction.FishingWait, new Frame(664, 6, 2, 120, 664, 6, 2, 120));
            frame.Frames.Add(MirAction.FishingReel, new Frame(728, 8, 0, 100, 728, 8, 0, 100));
            #endregion

            #region HighWarrior Frames
            HighPlayers.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 2, 200, 0, 6, 0, 200));  // ok
            frame.Frames.Add(MirAction.Walking, new Frame(64, 6, 2, 100, 48, 6, 0, 100)); // ok
            frame.Frames.Add(MirAction.Running, new Frame(128, 6, 2, 100, 96, 6, 0, 100)); // ok
            frame.Frames.Add(MirAction.Stance, new Frame(336, 6, 2, 200, 272, 6, 0, 200)); 
            frame.Frames.Add(MirAction.Stance2, new Frame(660, 1, 7, 800));
            frame.Frames.Add(MirAction.Attack1, new Frame(400, 6, 2, 100, 320, 6, 0, 100));//192, 8, 0, 100)); // 256 2  // 272 6 // 320 6 // 368 攻击 // 416 8 // 480 6 // 528 6 //576 8
            frame.Frames.Add(MirAction.Attack2, new Frame(464, 6, 2, 100, 368, 6, 0, 100));
            //frame.Frames.Add(MirAction.Attack3, new Frame(720, 8, 0, 100, 416, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack3, new Frame(720, 8, 0, 100, 576, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack4, new Frame(464, 6, 2, 100, 368, 6, 0, 100));
            frame.Frames.Add(MirAction.Spell, new Frame(656, 6, 2, 100, 480, 6, 0, 100)); // ok
            frame.Frames.Add(MirAction.Harvest, new Frame(320, 2, 0, 300, 256, 2, 0, 300));
            frame.Frames.Add(MirAction.Struck, new Frame(192, 3, 5, 100, 144, 6, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(256, 8, 0, 100, 192, 8, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(263, 1, 7, 800, 199, 1, 7, 800));
            ...
            //Mounts
            frame.Frames.Add(MirAction.MountStanding, new Frame(592, 4, 0, 500, 480, 6, 0, 250));
            frame.Frames.Add(MirAction.MountWalking, new Frame(624, 8, 0, 100, 528, 4, 0, 100));
            ...
            frame.Frames.Add(MirAction.Attack3, new Frame(528, 6, 2, 100, 528, 6, 2, 100));
            ...
            frame.Frames.Add(MirAction.Struck, new Frame(192, 3, 5, 100, 192, 6, 2, 100));
            ...
            frame.Frames.Add(MirAction.Revive, new Frame(256, 8, 0, 100, 256, 8, 0, 100) { Reverse = true });
            frame.Frames.Add(MirAction.Mine, new Frame(392, 8, 0, 100));
            //Assassin
            frame.Frames.Add(MirAction.Sneek, new Frame(464, 6, 0, 100));
            frame.Frames.Add(MirAction.DashAttack, new Frame(80, 3, 3, 100));
            ...
            frame.Frames.Add(MirAction.Jump, new Frame(288, 8, 0, 100));
            //Mounts
            frame.Frames.Add(MirAction.MountStanding, new Frame(592, 4, 0, 500)); // 592 656
            ...
            frame.Frames.Add(MirAction.Attack4, new Frame(464, 6, 2, 100, 464, 6, 2, 100));
            frame.Frames.Add(MirAction.Spell, new Frame(656, 6, 2, 100, 656, 6, 2, 100));
            frame.Frames.Add(MirAction.Harvest, new Frame(320, 2, 0, 300, 320, 2, 300));
            frame.Frames.Add(MirAction.Struck, new Frame(192, 3, 5, 100, 192, 6, 2, 100));
            frame.Frames.Add(MirAction.Die, new Frame(256, 8, 0, 100, 256, 8, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(263, 1, 7, 800, 263, 1, 7, 800));
            frame.Frames.Add(MirAction.Revive, new Frame(256, 8, 0, 100, 256, 8, 0, 100) { Reverse = true});
            ...
            frame.Frames.Add(MirAction.Jump, new Frame(288, 8, 0, 100));
            //Mounts
            frame.Frames.Add(MirAction.MountStanding, new Frame(592, 4, 0, 500)); // 592 6 2 //656  // TODO 592是什么
            frame.Frames.Add(MirAction.MountWalking, new Frame(624, 8, 0, 100));
            frame.Frames.Add(MirAction.MountRunning, new Frame(688, 6, 0, 100));
            frame.Frames.Add(MirAction.MountStruck, new Frame(736, 3, 0, 100));
            frame.Frames.Add(MirAction.MountAttack, new Frame(760, 6, 0, 100));
            ...
            HighPlayers.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 2, 200, 0, 6, 2, 200));
            frame.Frames.Add(MirAction.Walking, new Frame(128, 6, 2, 100, 128, 6, 2, 100));
            frame.Frames.Add(MirAction.Running, new Frame(192, 6, 2, 100, 192, 6, 2, 100));
            frame.Frames.Add(MirAction.Stance, new Frame(400, 6, 2, 200, 400, 6, 2, 200));
            frame.Frames.Add(MirAction.Stance2, new Frame(660, 1, 7, 800));
            frame.Frames.Add(MirAction.Attack1, new Frame(464, 6, 2, 100, 464, 6, 2, 100));
            frame.Frames.Add(MirAction.Attack2, new Frame(592, 6, 2, 100, 592, 6, 2, 100)); //656
            frame.Frames.Add(MirAction.Attack3, new Frame(848, 8, 0, 100, 848, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack4, new Frame(528, 6, 2, 100, 528, 6, 2, 100));
            frame.Frames.Add(MirAction.Spell, new Frame(784, 6, 2, 100, 784, 6, 2, 100));  // 720
            frame.Frames.Add(MirAction.Harvest, new Frame(384, 2, 0, 300, 384, 2, 0, 300));
            frame.Frames.Add(MirAction.Struck, new Frame(256, 3, 5, 100, 256, 6, 2, 100));
            frame.Frames.Add(MirAction.Die, new Frame(320, 8, 0, 100, 320, 8, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(327, 1, 7, 800, 327, 1, 7, 800));
            frame.Frames.Add(MirAction.Revive, new Frame(320, 8, 0, 100, 320, 8, 0, 100) { Reverse = true});
            frame.Frames.Add(MirAction.Mine, new Frame(392, 8, 0, 100));
            //Assassin
            frame.Frames.Add(MirAction.Sneek, new Frame(64, 6, 2, 100, 64, 6, 2, 100));
            frame.Frames.Add(MirAction.DashAttack, new Frame(192, 3, 5, 100, 192, 6, 2, 100));
            //Archer
            frame.Frames.Add(MirAction.WalkingBow, new Frame(0, 6, 0, 100));
            frame.Frames.Add(MirAction.RunningBow, new Frame(48, 6, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(96, 8, 0, 100));
            ...
            HighPlayers.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 2, 200, 0, 6, 2, 200));
            frame.Frames.Add(MirAction.Walking, new Frame(0, 6, 2, 100, 0, 6, 2, 100));
            ...
            frame.Frames.Add(MirAction.DashAttack, new Frame(80, 3, 3, 100));
            //Archer
            frame.Frames.Add(MirAction.WalkingBow, new Frame(0, 6, 2, 100, 0, 6, 2, 100));
            frame.Frames.Add(MirAction.RunningBow, new Frame(64, 6, 2, 100, 64, 6, 2, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(128, 8, 0, 100, 128, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(192, 8, 0, 100, 192, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(256, 8, 0, 100, 256, 8, 0, 100));
            frame.Frames.Add(MirAction.Jump, new Frame(320, 8, 0, 100, 320, 8, 0, 100));
            //Mounts
            frame.Frames.Add(MirAction.MountStanding, new Frame(592, 4, 0, 500));
            frame.Frames.Add(MirAction.MountWalking, new Frame(624, 8, 0, 100));
            frame.Frames.Add(MirAction.MountRunning, new Frame(688, 6, 0, 100));
            ...
            //21 2 frames + animation(9 frames) (small tele)
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 2, 0, 1250, 10, 9, 0, 250));

            //22
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 6, 1000));
            frame.Frames.Add(MirAction.Harvest, new Frame(30, 10, 0, 200));

            //23 2 frames + animation(9 frames) (small tele)
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 2, 0, 1250));
            #endregion
            ...
            frame.Frames.Add(MirAction.Die, new Frame(176, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(184, 1, 8, 1000) { Reverse = true });
            frame.Frames.Add(MirAction.Attack2, new Frame(248, 6, 0, 100));
            ...
            frame.Frames.Add(MirAction.Dead, new Frame(209, 1, 9, 1000) { Reverse = true });
            frame.Frames.Add(MirAction.Attack2, new Frame(280, 7, 0, 100));
            ...
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 2, -2, 500));
            frame.Frames.Add(MirAction.Attack1, new Frame(2, 4, 0, 200));
            ...
            frame.Frames.Add(MirAction.Running, new Frame(120, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(168, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(312, 8, 0, 100)); //stupple 08/04
            frame.Frames.Add(MirAction.AttackRange3, new Frame(376, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 7, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(152, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(216, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(240, 7, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(246, 1, 6, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(240, 7, 0, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(240, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(168, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(248, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange2, new Frame(264, 10, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(168, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(224, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(280, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange4, new Frame(344, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(408, 4, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(440, 8, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(447, 1, 7, 1000));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(64, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(112, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(192, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(256, 10, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(56, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(104, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(232, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(128, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(184, 7, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(48, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(152, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(208, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(72, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(120, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(200, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(280, 3, 0, 200));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(64, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(112, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(192, 10, 0, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(120, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(200, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(280, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(360, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(440, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(464, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(473, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(464, 1, 0, 100) { Reverse = true });
            frame.Frames.Add(MirAction.Show, new Frame(358, 9, 0, 200));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(192, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(272, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(344, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange4, new Frame(416, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(496, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(520, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(0, 2, -2, 80));
            frame.Frames.Add(MirAction.Running, new Frame(0, 2, -2, 80));
            frame.Frames.Add(MirAction.Struck, new Frame(0, 2, -2, 200));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(136, 3, 0, 200));
            frame.Frames.Add(MirAction.Struck, new Frame(160, 3, 0, 200));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(88, 6, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(144, 9, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(216, 3, 0, 200));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(144, 7, 0, 200));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(200, 8, 0, 200));
            ...
            frame.Frames.Add(MirAction.Revive, new Frame(216, 8, 0, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(200, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(256, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(368, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange4, new Frame(424, 7, 0, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(144, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(216, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(280, 3, 0, 200));
            ...
            frame.Frames.Add(MirAction.AttackRange2, new Frame(160, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.Dead, new Frame(150, 1, -1, 1000));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(176, 10, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(232, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(304, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange4, new Frame(368, 8, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(176, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(240, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(320, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange4, new Frame(384, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange5, new Frame(448, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange6, new Frame(512, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange7, new Frame(592, 8, 0, 100));
            ...
            frame.Frames.Add(MirAction.Dead, new Frame(401, 1, 9, 1000));
            frame.Frames.Add(MirAction.Hide, new Frame(1, 1, 0, 500));
            frame.Frames.Add(MirAction.Running, new Frame(8, 7, 0, 100)); 
            ...
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 200));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(80, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(80, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(80, 9, 0, 100));
            frame.Frames.Add(MirAction.Jump, new Frame(152, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(216, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(240, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(248, 1, 8, 1000));
            ...
            //155 - JobKing
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 200));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 8, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(232, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(312, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange4, new Frame(392, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange5, new Frame(464, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange6, new Frame(544, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange7, new Frame(616, 5, 0, 100));
            ...
            frame.Frames.Add(MirAction.Dead, new Frame(456, 1, -1, 1000));
            ...
            frame.Frames.Add(MirAction.Dead, new Frame(701, 1, 9, 1000));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 9, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(232, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(256, 20, -11, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(232, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(312, 5, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(352, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(376, 20, -10, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(0, 8, 0, 200));
            frame.Frames.Add(MirAction.Standing, new Frame(64, 6, 0, 500));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(112, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(176, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(256, 3, 0, 200));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(192, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(248, 6, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(296, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(312, 6, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(317, 1, 5, 1000));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(296, 7, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(352, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(376, 15, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(390, 1, 14, 1000));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(176, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 7, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(208, 12, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(304, 6, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(352, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(376, 2, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(377, 1, 1, 1000));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(256, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(336, 10, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(240, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(320, 10, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(272, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(112, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(192, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(272, 10, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(144, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(224, 4, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(48, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(224, 2, 0, 200));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(112, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(176, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(240, 8, 0, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(120, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(184, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(256, 7, 0, 100));
            ...
            frame.Frames.Add(MirAction.Die, new Frame(168, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(177, 1, 9, 1000));
            frame.Frames.Add(MirAction.Attack2, new Frame(248, 8, 0, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(136, 12, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(232, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(256, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(265, 1, 9, 1000));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 13, 0, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange2, new Frame(216, 7, 0, 200));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(128, 10, 0, 200));
            frame.Frames.Add(MirAction.Struck, new Frame(208, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(232, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(241, 1, 9, 1000));
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(120, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(200, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(280, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(304, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(313, 1, 9, 1000));
            ...
            frame.Frames.Add(MirAction.Die, new Frame(208, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(217, 1, 9, 1000) { Reverse = true });
            frame.Frames.Add(MirAction.Attack2, new Frame(288, 7, 0, 100));

            //209 - Tucson, TucsonFighter
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(48, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 9, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(168, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(192, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(201, 1, 8, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(192, 10, 0, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Struck, new Frame(336, 2, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(352, 8, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(359, 1, 7, 1000));

            // 211 - snowflower
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 9, 0, 200));
            frame.Frames.Add(MirAction.Walking, new Frame(72, 7, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(128, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(184, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(248, 3, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(272, 7, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(278, 1, 6, 1000));

            // 212 - snowmouse
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 7, 0, 200));
            frame.Frames.Add(MirAction.Walking, new Frame(56, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(104, 7, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(160, 5, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(200, 7, 0, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(104, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(168, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(248, 5, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(288, 7, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(294, 1, 6, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(168, 7, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(224, 3, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(248, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(256, 1, 8, 100));
            ...
            frame.Frames.Add(MirAction.Jump, new Frame(184, 6, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(232, 4, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(264, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(273, 1, 9, 100));
            ...
            frame.Frames.Add(MirAction.Die, new Frame(264, 7, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(270, 1, 6, 100));
            ...
            frame.Frames.Add(MirAction.AttackRange3, new Frame(296, 7, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(352, 5, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(392, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(400, 1, 8, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(48, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(152, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.Dead, new Frame(327, 1, 7, 100));

            // 219 - 411
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 5, 0, 200));
            frame.Frames.Add(MirAction.Walking, new Frame(40, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(88, 6, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(136, 7, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(192, 4, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(224, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(233, 1, 9, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(48, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(152, 3, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(176, 4, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(208, 3, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(232, 8, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(239, 1, 7, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(48, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 6, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(144, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(208, 9, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(280, 3, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(304, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(313, 1, 9, 100));
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(32, 5, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(96, 6, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(120, 9, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(192, 4, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(224, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(232, 1, 8, 100));

            // 223 - 418 M249
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 8, 0, 200));
            frame.Frames.Add(MirAction.Walking, new Frame(64, 6, 0, 200));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(112, 9, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(184, 9, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(256, 3, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(280, 9, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(288, 1, 8, 100));
            ...
            frame.Frames.Add(MirAction.Struck, new Frame(264, 3, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(288, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(297, 1, 9, 100));
            ...
            frame.Frames.Add(MirAction.Struck, new Frame(256, 3, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(280, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(289, 1, 9, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(112, 7, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(168, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(248, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(312, 4, 0, 100));
            frame.Frames.Add(MirAction.Die, new Frame(344, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(353, 1, 9, 100));

            // 227  MoreaWind
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 7, 3, 200) { Blend = true });
            frame.Frames.Add(MirAction.Walking, new Frame(80, 7, 3, 200) { Blend = true });
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100) { Blend = true });
            frame.Frames.Add(MirAction.Struck, new Frame(240, 3, 7, 100) { Blend = true });
            frame.Frames.Add(MirAction.Die, new Frame(320, 10, 0, 100) { Blend = true });
            frame.Frames.Add(MirAction.Dead, new Frame(329, 1, 9, 100) { Blend = true });
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 8, 0, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(144, 7, 0, 100));
            ...
            // 229 KunLun0  480
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Show, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Standing, new Frame(80, 6, 4, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(320, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(400, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(409, 1, 9, 1000));
            frame.Frames.Add(MirAction.Hide, new Frame(480, 6, 4, 100));
            frame.Frames.Add(MirAction.Revive, new Frame(410, 10, 0, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 9, 1, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(320, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(400, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(409, 1, 9, 1000));
            frame.Frames.Add(MirAction.Hide, new Frame(480, 6, 4, 100));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(480, 9, 0, 100));
            ...
            frame.Frames.Add(MirAction.Dead, new Frame(489, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(490, 10, 0, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 8, 2, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 7, 200));
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 9, 1, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(480, 9, 1, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(489, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(490, 10, 0, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Dead, new Frame(487, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(487, 8, 2, 100) { Reverse = true });

            // 238   489
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 6, 4, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 200));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(160, 7, 3, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(240, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(320, 3, 7, 200));
            frame.Frames.Add(MirAction.Die, new Frame(400, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(407, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(407, 8, 2, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(320, 8, 2, 200));
            frame.Frames.Add(MirAction.Running, new Frame(400, 4, 6, 100));
            frame.Frames.Add(MirAction.Die, new Frame(480, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(487, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(487, 8, 2, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 8, 2, 200));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 6, 100));
            frame.Frames.Add(MirAction.Die, new Frame(480, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(487, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(487, 8, 2, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 8, 2, 100));
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 8, 2, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 9, 1, 200));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 6, 100));
            frame.Frames.Add(MirAction.Die, new Frame(480, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(489, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(489, 8, 2, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 9, 1, 200));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 4, 6, 100));
            frame.Frames.Add(MirAction.Die, new Frame(480, 9, 1, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(488, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(489, 8, 2, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(400, 3, 7, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(480, 19, 1, 100));
    
            // 244           
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(640, 6, 4, 500) );
            frame.Frames.Add(MirAction.Walking, new Frame(720, 6, 4, 200) );
            frame.Frames.Add(MirAction.AttackRange1, new Frame(800, 10, 0, 100) );
            frame.Frames.Add(MirAction.AttackRange2, new Frame(880, 9, 1, 150) );
            frame.Frames.Add(MirAction.AttackRange3, new Frame(960, 9, 1, 100) );
            frame.Frames.Add(MirAction.Struck, new Frame(1040, 3, 7, 100) );
            frame.Frames.Add(MirAction.Die, new Frame(1120, 10, 0, 100) );
            frame.Frames.Add(MirAction.Dead, new Frame(1129, 1, 9, 100) );
            ...
            frame.Frames.Add(MirAction.Walking, new Frame(80, 6, 4, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(160, 10, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(240, 3, 7, 100));
            frame.Frames.Add(MirAction.Die, new Frame(320, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(328, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(328, 8, 2, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(400, 10, 0, 100));
            frame.Frames.Add(MirAction.AttackRange4, new Frame(480, 7, 3, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(560, 3, 7, 100));
            frame.Frames.Add(MirAction.Die, new Frame(640, 7, 3, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(646, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(646, 10, 0, 100) { Reverse = true });
            ...
            frame.Frames.Add(MirAction.AttackRange1, new Frame(240, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange2, new Frame(320, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange3, new Frame(400, 9, 1, 100));
            frame.Frames.Add(MirAction.AttackRange4, new Frame(480, 8, 2, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(560, 3, 7, 100));
            frame.Frames.Add(MirAction.Die, new Frame(640, 8, 2, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(647, 1, 9, 1000));
            frame.Frames.Add(MirAction.Revive, new Frame(647, 8, 2, 100) { Reverse = true });

            // 253 //龙卷风
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 8, -8, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(0, 8, -8, 200));
            frame.Frames.Add(MirAction.Struck, new Frame(0, 8, -8, 200));

            // 254 505
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 1, -1, 200));
            frame.Frames.Add(MirAction.Attack1, new Frame(0, 1, -1, 200));
            frame.Frames.Add(MirAction.Struck, new Frame(0, 1, -1, 200));
            #endregion
