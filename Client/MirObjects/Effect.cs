...
namespace Client.MirObjects
{
    public class Effect
    {
        ...
        public virtual void Process()
        {
            ...
            {
                if (FrameIntervals != null && FrameIntervals.ContainsKey(CurrentFrame))
                    NextFrame += FrameIntervals[CurrentFrame];
                else
                    NextFrame = Start + (Duration / Count) * (CurrentFrame + 1);
            }
        ...
        public virtual void Draw()
        {
            ...
            if (CurrentFrame > Count) return;

            if (Owner != null)
            {
                DrawLocation = Owner.DrawLocation;
                DrawLocation.Offset(new Point(OffsetLocation.X * MapControl.CellWidth, OffsetLocation.Y * MapControl.CellHeight));
            }
            else
            {
            ...
            if (Blend)
                Library.DrawBlendEx(BaseIndex + CurrentFrame, DrawLocation, Color.White, true, Rate);
            else
    ...
    public class Missile : Effect
    {
        ...
        public override void Draw()
        {
            ...
            if (!Blend)
                ...
                Library.DrawBlendEx(index, DrawLocation, Color.White, true, Rate);
        }
