...
namespace Client.MirObjects
{
    class NPCObject : MapObject
    {
        ...
        public void Load(S.ObjectNPC info)
        {
            ...
            Quests = GameScene.QuestInfoList.Where(c => c.NPCIndex == info.NPCIndex).ToList();
        ...
        public List<ClientQuestProgress> GetAvailableQuests(bool returnFirst = false)
        {
            ...
            {
                if (q.QuestInfo.FinishNPCIndex == NPCIndex)
                {
                    quests.Add(q);
                }
                else if (q.QuestInfo.NPCIndex == NPCIndex && q.QuestInfo.SameFinishNPC)
                {
                    quests.Add(q);
