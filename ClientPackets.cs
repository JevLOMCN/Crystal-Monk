...
public sealed class AwakeningNeedMaterials : Packet
    ...
    public sealed class Awakening : Packet
    {
        ...
        public ulong UniqueID;
        public AwakeType Type;
        public ulong MaterialUniqueID;

        protected override void ReadPacket(BinaryReader reader)
        {
            UniqueID = reader.ReadUInt64();
            Type = (AwakeType)reader.ReadByte();
            MaterialUniqueID = reader.ReadUInt64();
        }
        protected override void WritePacket(BinaryWriter writer)
        {
            writer.Write(UniqueID);
            writer.Write((byte)Type);
            writer.Write(MaterialUniqueID);
        }
    }
    ...
    {
        public override short Index { get { return (short)ClientPacketIds.RearrangeInventory; } }
    ...
    public sealed class DownloadFile : Packet
    {
        ...
        public uint Start;
        public override short Index { get { return (short)ClientPacketIds.DownloadFile; } }
    ...
    public sealed class ChangeNameReturn : Packet
    {
        public override short Index
        {
            get { return (short)ClientPacketIds.ChangeNameReturn; }
        }
        public string Name;
        protected override void ReadPacket(BinaryReader reader)
        {
